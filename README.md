...
**In**terpretable **t**ime **s**eries autoregression for periodicity quantification (**ints** ⮕ **integers**). [[Slides](https://xinychen.github.io/slides/ints.pdf)] [[Project description](https://xinychen.github.io/tutorial/integers.pdf)]
